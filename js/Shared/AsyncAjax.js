...
var AsyncAjax = (function () {
    ...
    AsyncAjax.PostWithToken = function (data) {
        var _this = this;
        var token = new PromiseToken();
        return {
            Promise: new Promise(function (resolve) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    jQuery.post(smartformsrecordingparams.ajaxurl, data, function (data) {
...
var PromiseToken = (function () {
    function PromiseToken() {
        this.WasCancelled = false;
    }
    PromiseToken.prototype.Cancel = function () {
        this.WasCancelled = true;
    };
    return PromiseToken;
}());
exports.PromiseToken = PromiseToken;
